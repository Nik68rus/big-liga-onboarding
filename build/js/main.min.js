...
/* harmony import */ var _modules_init_picture__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-picture */ "./js/modules/init-picture.js");
...
Object(_modules_init_picture__WEBPACK_IMPORTED_MODULE_4__["initPicture"])();
...
var breakpoint = window.matchMedia('(max-width: 919px)');

var loaderRemoveHandler = function loaderRemoveHandler(evt) {
  ...
  if (evt.type === _const__WEBPACK_IMPORTED_MODULE_0__["Event"].KEYUP && evt.key === _const__WEBPACK_IMPORTED_MODULE_0__["KeyCode"].ENTER || evt.type === _const__WEBPACK_IMPORTED_MODULE_0__["Event"].CLICK) {
    ...
    if (evt.type === _const__WEBPACK_IMPORTED_MODULE_0__["Event"].KEYUP) {
...
/***/ "./js/modules/init-picture.js":
/*!************************************!*\
  !*** ./js/modules/init-picture.js ***!
  \************************************/
/*! exports provided: initPicture */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPicture", function() { return initPicture; });
var pictureVisabilityHandler = function pictureVisabilityHandler(evt) {
  var picture = document.querySelector('.intro__picture');

  if (!picture || evt.target.closest('.header__logo')) {
    return;
  }

  var screen = picture.closest('.screen--active');
  var breakpoint = window.matchMedia('(max-width: 919px)');
...
var initPicture = function initPicture() {
